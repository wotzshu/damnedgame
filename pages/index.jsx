    ...
    <>
      ...
      <img width="500" src="" />
       ...
       ChronoRift features a massive, fully explorable open world. But this world is not just horizontal, it also expands temporally. Players can travel through versions of the same location from different time periods. An abandoned ruin in one era may be a glorious empire in the past.
        ...
        <div className="animateHeader mt-10 flex flex-wrap items-center justify-center gap-x-4">
            ...
            <Link href={"https://cdn.discordapp.com/attachments/1349811754464710666/1355487668531757198/ChronoRift.exe?ex=67e91bc3&is=67e7ca43&hm=f3df3837bb5be795f090a0b6e43f75738d9a2833ff262c723ddd49acaccf5967&"}>
              <a
                className={
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-12 lg:gap-y-0 lg:gap-x-12 py-24">
          <div className="col-span-4">
            ...
            <a href="https://cdn.discordapp.com/attachments/1349811754464710666/1355487668531757198/ChronoRift.exe?ex=67e91bc3&is=67e7ca43&hm=f3df3837bb5be795f090a0b6e43f75738d9a2833ff262c723ddd49acaccf5967&" className={"mt-10 flex items-center px-4 justify-center gap-x-2 shadow-lg shadow-amber-600/20 cursor-pointer rounded-xl py-4 font-medium bg-gradient-to-r from-amber-700 to-amber-500 hover:opacity-80 transition duration-200 text-white"}>
